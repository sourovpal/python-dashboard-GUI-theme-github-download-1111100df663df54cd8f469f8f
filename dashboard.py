...
class Dashboard2:
    def __init__(self, window, screen_width, screen_height):
        ...
        self.header.place(x=300, y=0, width=(screen_width - 300), height=60)

        self.logout_text = Button(self.header, text="Logout", bg='#32cf8e', font=("", 13, "bold"), bd=0, fg='white',
                                  cursor='hand2', activebackground='#32cf8e')
        self.logout_text.place(x=(screen_width-390), y=15)

        # ==============================================================================
        # ================== SIDEBAR ===================================================
        # ==============================================================================
        self.sidebar = Frame(self.window, bg='#ffffff')
        self.sidebar.place(x=0, y=0, width=300, height=screen_height)
        ...
        self.bodyFrame1.place(x=328, y=110, width=(screen_width - 355), height=350)
        ...
        self.brandName = Label(self.sidebar, text='Sourov Pal', bg='#ffffff', font=("", 15, "bold"))
...
def wind():
    ...
    Dashboard2(window, screen_width, screen_height)
    window.mainloop()
